...
in
{
  ...
  home.packages = with pkgs; [ playerctl brightnessctl pamixer swaybg ];
  ...
  xdg.configFile."hypr/hyprland.conf" = {
    ...
    bind = $mainMod, t, exec, dunstify "time: $(date)" 
    ...
    # battery
    bind = $mainMod, b, exec, dunstify "battery: $(cat /sys/class/power_supply/BAT0/capacity)%" 
